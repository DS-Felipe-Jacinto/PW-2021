				...
				<div class="tm-header">
					<div class="row tm-header-inner">
						...
						<nav class="col-md-6 col-12 tm-nav">
							<ul class="tm-nav-ul">
								<li class="tm-nav-li"><a href="index.php" class="tm-nav-link active">Sobre</a></li>
								<li class="tm-nav-li"><a href="contact.php" class="tm-nav-link">Contato</a></li>
								<li class="tm-nav-li"><a href="form_login.html" class="tm-nav-link">Entrar</a></li>
								<li class="tm-nav-li"><a href="form_cadastro.html" class="tm-nav-link">Cadastrar</a></li>
							</ul>
						</nav>	
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="tm-description-box"> 
							...
							<p class="tm-mb-45">Logo abaixo vocês podem realizar o cadastro para acessar a categoria dos nossos livros, e entrar para o nosso time de colaboradores. Nós da Biblioteca SP, agradecemos pela confiança.</p>
							<a href="form_cadastro.html" class="tm-btn tm-btn-default tm-right">Faça seu Cadastro!</a>
